...
disp([char(datetime('now','Format','HH:mm:ss')) '  Step 1. Loaded measured data and Defined empty variables'])


% PLOT:
which_chan = 8; % For "Ink_plotting.m"
show_chan = 8; % Channel shown in Publication 2023
show_fig = {'5a'};
...
% PLOT:
show_chan = 8; % Channel shown in Publication 2023
show_fig = {'5a','6a','6b','Optional_1','Optional_2'};
Ink_plotting(DTOF,Time_ns,IRF,delMom,LMA1_MuaMusp,LMA2_Mua1Mua2,LMA1_Optional, set_dim, show_chan, show_fig);
